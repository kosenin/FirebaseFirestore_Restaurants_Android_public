...
/**
 * Диалоговый фрагмент содержащий фильтры для выбора
 */
public class FilterDialogFragment extends DialogFragment {

    public static final String TAG = "FilterDialog";

    // интерфейс для передачи информации в MainActivity в случае выбора фильтра пользователем
    ...
    // "слушатель" (интерфейс, который имплементирует MainActivity)
    ...
    // Прикрепляем инстанцию интерфейса (это по сути MainActivity) для передачи данных
    @Override
    ...
    // в случае клика на кнопку поиска передаем информацию в MainActivity
    ...
    // Берем выбранную категорию в фильтре
    @Nullable
    ...
    // Берем выбранный город в фильтре
    @Nullable
    ...
    // Берем выбранную цену в фильтре
    ...
    // Берем выбранную сортировку в фильтре
    @Nullable
    ...
    // Переводим фильтры в первоначальное положение
    ...
    // Устанавливаем выбранные фильтры и возвращаем их
